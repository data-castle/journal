...
// setupTestJournalWithTwoKeys creates a test journal with two encryption keys
// Returns: tmpDir, journalCfg, publicKey1, publicKey2
func setupTestJournalWithTwoKeys(t *testing.T) (string, *config.Journal, string, string) {
	tmpDir := t.TempDir()
	...
	return tmpDir, journalCfg, publicKey1, publicKey2
}
